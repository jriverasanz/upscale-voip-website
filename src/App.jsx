          ...
          <div className="max-w-6xl mx-auto grid gap-6 md:grid-cols-[1.2fr_0.8fr] items-start">
            <div className="bg-white rounded-[1.75rem] border border-brand-navy/10 p-6 shadow-card space-y-6">
              <div className="flex items-center gap-4 mb-2">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-violet to-brand-navy flex items-center justify-center text-white font-bold text-sm">
                  SG
                </div>
                <div>
              ...
              <p className="text-brand-charcoal/70">
                Snap.Go is a softphone with full portal capabilities including
                visual voicemail, call history, contacts, greetings, and
                answering rules — all from your mobile device. Available
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  >
                    <svg
                      className="w-4 h-4 text-brand-violet flex-shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                <a
                  href="#"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-black text-white text-sm font-semibold hover:bg-gray-800 transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
              ...
              <details className="group">
                <summary className="cursor-pointer text-brand-violet font-semibold hover:text-brand-violet/80 transition-colors list-none flex items-center gap-2 text-sm">
                ...
                <div className="mt-3 p-4 bg-brand-softblue/50 rounded-xl space-y-2 text-sm text-brand-charcoal/70">
                  <p>
                    When launching Snap.Go for the first time, enter the
                    following details:
                  </p>
                  <ul className="space-y-1">
                    <li>
                      <strong>Host/ID:</strong> mypbx
                    </li>
                    <li>
                      <strong>Login:</strong> ext@pbx-id
                    </li>
                    <li>
                  ...
                  <p>
                    After the initial login, this data will be stored and not
